...
public class LoggingInterceptor {
    ...
    public void afterThrowing(JoinPoint joinPoint, Throwable ex) {
        LoggerFactory.getLogger(joinPoint.getTarget().getClass()).error("Exception intercept err",ex);
        LoggerFactory.getLogger(joinPoint.getTarget().getClass()).error("Method-[{}] Input-{} ERROR UPDATED: {}", joinPoint.getSignature(), joinPoint.getArgs(), ex.getStackTrace());
    }
}